...
import { Box, Flex, FormControl, Heading, Input, VStack, Image, Button } from '@chakra-ui/react';
    ...
    <VStack w='100%' h='600px' bgColor='#000' className='paddinglr' justifyContent='center' id='contact'>
      ...
      <Box w='45%'>
        <FormControl display='flex' flexDirection='column' gap='35px'>
            ...
            <Button bgColor='#FFFFFF' color='#17153D' borderRadius='48px' py='10px' px='20px'>Submit</Button>
        </FormControl>
      </Box>
      <Box w='45%'>
